...
def add_arguments(parser):
    ...
    parser.add_argument("--from_vocab_size", type=int, default=511, help="source vocabulary size")
    parser.add_argument("--to_vocab_size", type=int, default=511, help="target vocabulary size")
    parser.add_argument("--encoder_num_layers", type=int, default=1, help="Number of layers in the model for encoder")
    parser.add_argument("--decoder_num_layers", type=int, default=3, help="Number of layers in the model for decoder")
    ...
    while global_step <= 380000:
        ...
        if  global_step % 3000 == 0:
            ...
            for id in range(0, int(len(valid_data) / hparams.batch_size)):
                ...
                given, answer, predict, predict_nobeam = infer_model.model.infer_step(infer_sess, test_data, no_random=True,
